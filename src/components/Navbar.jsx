...
//     { id: 'reports', label: 'Contact Us' }
//   ];

//   return (
//     <nav className="bg-zinc-900 shadow-2xl mb-[50px] z-50 fixed top-0 left-0 right-0">
...
//           <button className="bg-zinc-800 px-5 py-2 rounded-lg text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-zinc-900 transition-all duration-200 shadow-lg hover:shadow-indigo-500/50">
//             Login
//           </button>
//         </div>
...
//         <button className="bg-zinc-800 w-full px-4 py-2.5 rounded-lg text-sm font-medium text-white hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 focus:ring-offset-zinc-800 transition-all duration-200">
//           Login
//         </button>
//       </div>
//     </div>
